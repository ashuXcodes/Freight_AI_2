...
# ========================================
# 3. CREATE FEATURES AND TARGET DATA
# ========================================
...
# ========================================
# 10. RANDOM FOREST BENCHMARK
# ========================================

random_forest_mae = 201.11
random_forest_rmse = 273.41
...
print(
    ...
    f"{random_forest_rmse:>12.2f}"
)

print(
    f"{'Gradient Boosting':<25}"
    f"{test_mae:>10.2f}"
    f"{test_rmse:>12.2f}"
)
...
results["gradient_boosting_prediction"] = test_prediction
