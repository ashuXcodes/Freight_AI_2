...
print(f"{'XGBoost':<30}{xgb_mae:>10.2f}{xgb_rmse:>12.2f}")
print(f"{'LightGBM':<30}{test_mae:>10.2f}{test_rmse:>12.2f}")
print()
...
sample_predictions["lightgbm_prediction"] = test_predictions

print("SAMPLE PREDICTIONS")
print("----------------------------------------")
print(
    sample_predictions.head(10).to_string(
        index=False
    )
)